<template>
  <div class=" page lg:container lg:mx-auto text-gray-800">
      ...
      <div v-if="course" class=" grid grid-cols-10 my-10">
          ...
          <div v-if="course"  class="col-span-10  md:p-0 md:col-span-3 border bg-white flex flex-col  items-center ">
            <div class=" text-2xl tracking-tight mx-4 mt-4  text-center leading-6 font-semibold   ">{{course.title}}</div>
            <div v-if="course.subtitle" class=" mx-4 text-center mb-2 text-sm xl:text-base">"{{course.subtitle}}"</div>
            ...
            <div class=" lg:mt-4 italic text-lg tracking-tighter">This course includes:</div>
            ...
            <div v-if="course.sentences.length>0" class=" lg:mt-4 hidden lg:block italic text-lg ">You will learn:</div>
            <div v-if="course.sentences.length>0" class=" hidden lg:flex lg:flex-col  self-start ml-8">
            ...
            <div v-if="!isVisible" style="background-color:#ffd43b; color:midnightblue" @click="buyCourse" class=" mt-6 md:mt-auto  text-gray-800 hover:bg-yellow-400  duration-150 pb-2 pt-1 px-10 mb-2 rounded-xl  flex flex-col justify-center items-center text-lg cursor-pointer">
                <div v-if="sale" class="">
            ...
            <div v-else style="background-color:#ffd43b; color:midnightblue" class="  md:mt-auto    hover:bg-yellow-400  duration-150 p-2 px-10 mb-2 rounded-xl  flex flex-col justify-center items-center text-lg cursor-pointer">
                <div class=" font-semibold ">Continue to learn</div>
            </div>
          </div>
