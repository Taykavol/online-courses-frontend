...
<div :class="{'border-b':this.reviews.length==0}" class="bg-white  w-full  border-l border-t border-r  relative  ">
   ...
   <div v-if="this.reviews.length!=0" class=" flex flex-col">
