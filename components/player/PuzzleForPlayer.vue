      ...
      <div ref="chessboard" :class="{'mt-4':level}" class=" z-50  chessboard relative ">
        ...
        <div v-if="isPromotionMove" class=" absolute  inset-0 w-56   text-lg flex   h-full  items-center justify-center  ">
          <div v-if="turn=='w'" class=" flex justify-center items-center bg-gray-800 bg-opacity-50 h-10 ">
              <div @click="setPiece('Q')"  :class="['rounded-full w-10 h-10 transform scale-75 hover:scale-90 duration-300 ']">
              ...
              <div @click="setPiece('R')" :class="['rounded-full w-10 h-10 transform scale-75 hover:scale-90 duration-300']">
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
                      <g style="opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;">
                          <path
              ...
              <div @click="setPiece('B')" :class="['rounded-full w-10 h-10 transform scale-75 hover:scale-90 duration-300']">
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
              ...
              <div @click="setPiece('N')" :class="['rounded-full w-10 h-10 transform scale-75 hover:scale-90 duration-300']">
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
          ...
          <div v-else class="flex justify-center items-center bg-gray-800 bg-opacity-50 h-10">
            <div @click="setPiece('Q')"  :class="['rounded-full w-10 h-10 transform scale-75 hover:scale-90 duration-300 ']">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
  ...
  mounted() {
    ...
    let inputHandler =async event => {
      if (event.type == INPUT_EVENT_TYPE.moveDone) {
        ...
        if (result) {
          console.log('Hope we are not here')
