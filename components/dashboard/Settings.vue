<template>
  <!-- component -->
<!-- component -->
    <div class=" min-h-screen w-full font-mono my-1 pt-2 pb-2 px-10 flex-1 bg-gray-200  rounded-l-lg ">
                    ...
                    <div class='flex flex-wrap -mx-3 mb-6'>
                        ...
                        <div class="personal w-full border-t border-gray-400 pt-4">
                            ...
                            <div class='w-full md:w-full px-3 mb-6'>
                                ...
                                <textarea class='bg-gray-100 rounded-md border leading-normal resize-none w-full h-20 py-2 px-3 shadow-inner border border-gray-400 font-medium placeholder-gray-700 focus:outline-none focus:bg-white'  ></textarea>
                            </div>
